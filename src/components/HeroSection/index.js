...
const contractAddress = "0xEC09Cf277e436E44D826F44B78146d8151b6AAA8";
...
const HeroSection = () => {
  ...
  return (
    <HeroContainer>
      ...
      <HeroContent>
        <MintDiv>
          <MiniAbout>0xInvisibleFriends is an expansion collection of 5,000 unique animated Invisible Friends hiding in the metaverse. </MiniAbout>
          <First>#YellowArmy</First>
          <Then>0.01Ξ each (max 25 NFT / tx.)</Then>
          <Minted>
